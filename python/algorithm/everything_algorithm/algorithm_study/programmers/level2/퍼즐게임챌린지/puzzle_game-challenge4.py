def solution(diffs, times, limit):
    ...
    def total_time(level):
        time_prev, total_time_count = 0, 0
...
# level에 따라 퍼즐을 푸는데 걸리는 시간은 다음과 같습니다.
...
# 전체 제한 시간 limit이 매개변수로 주어집니다. 제한 시간 내에 퍼즐을
# 모두 해결하기 위한 숙련도의 최솟값을 정수로 return 하도록 solution 함수를 완성해 주세요.